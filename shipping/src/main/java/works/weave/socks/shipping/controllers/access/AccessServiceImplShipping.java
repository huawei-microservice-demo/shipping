...
public class AccessServiceImplShipping extends AccessServiceShipping
{

    private CloseableHttpClient client = null;

    public AccessServiceImplShipping(String serviceName, String region, String ak, String sk)
    {
